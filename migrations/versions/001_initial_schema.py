...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('facility_type', sa.Enum('BasicFreeway', 'TwoLaneHighway', 'MultilaneHighway', 'UrbanStreet', name='facilitytype'), nullable=False),
        sa.Column('unit', sa.String(50), nullable=True),
        sa.Column('data_type', sa.Enum('float', 'integer', 'percentage', 'enum', name='datatype'), nullable=False, server_default='float'),
        sa.Column('description', sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('rule_type', sa.Enum('range', 'min', 'max', 'enum', 'formula', 'relationship', name='ruletype'), nullable=False),
        sa.Column('severity', sa.Enum('error', 'warning', 'info', name='severity'), nullable=False, server_default='error'),
    ...
    op.create_index('ix_condition_value_condition_type_id', 'condition_value', ['condition_type_id'])
